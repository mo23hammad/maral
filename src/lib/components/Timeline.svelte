...
<DatePicker.Root weekdayFormat="short" fixedWeeks={true} bind:value={value}>
  <div class="flex w-full max-w-[232px] flex-col gap-1.5">
    <DatePicker.Label class="text-[12px] font-semibold tracking-[0.12em] text-[#0B0D10]/55"
      >Handover Time</DatePicker.Label
    >
    <DatePicker.Input
      class="h-input rounded-2xl border-black/15 bg-background text-foreground focus-within:border-border-input-hover focus-within:shadow-date-field-focus hover:border-border-input-hover flex w-full max-w-[232px] select-none items-center border px-2 py-3 text-sm tracking-[0.01em]"
    >
    ...
    <DatePicker.Content sideOffset={6} class="z-50">
      <DatePicker.Calendar
        class="border-dark-10 bg-white shadow-popover rounded-2xl border p-[22px]"
      >
